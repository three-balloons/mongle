import style from '@/pages/privacy/privacy.module.css';

export const Privacy = () => {
    const privacyContent = `
쓰리벌룬즈(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
...
이 개인정보 처리방침은 2024. 10. 03부터 적용됩니다.`;

    return (
        <div className={style.default}>
            <div className={style.title}>개인정보처리방침</div>
            <div className={style.context}>{privacyContent}</div>
        </div>
    );
};
