import style from '@/pages/termOfUse/termOfUse.module.css';
...
“어플”란 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래 할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
“이용자”란 “어플”에 접속하여 서비스를 이용하는 회원 및 비회원을 말합니다.
“회원”이라 함은 “어플”에 개인정보를 제공하여 회원등록을 한 자로서, “어플”의 정보를 지속적으로 제공받으며, “어플”이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
“비회원”이라 함은 회원에 가입하지 않고, “어플”이 제공하는 서비스를 이용하는 자를 말합니다.
...
<부칙>
본 약관은 2024년 10월 04일부터 적용한다.
`;

    return (
        <div className={style.default}>
            <div className={style.title}>이용 약관</div>
            <div className={style.context}>{TermOfUseContent}</div>
        </div>
    );
};
